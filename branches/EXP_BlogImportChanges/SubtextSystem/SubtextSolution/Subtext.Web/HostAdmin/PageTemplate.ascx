...
<HTML>
	<HEAD>
		<title>
			<MP:ContentRegion id="MPTitle" runat="server" /></title>
<?xml version="1.0" ?>
		<link rel="stylesheet" type="text/css" href="~/HostAdmin/style/Style.css" runat="server"
			ID="Link1">
			<link rel="stylesheet" type="text/css" href="~/Admin/Resources/scripts/helptip.css" runat="server"
				ID="Link2">
				...
				<div id="logo">
					<div id="loginStatus">Logged in As
						<span id="hostAdminName">
							<asp:Literal ID="hostAdminName" Runat="server" />
						</span>
