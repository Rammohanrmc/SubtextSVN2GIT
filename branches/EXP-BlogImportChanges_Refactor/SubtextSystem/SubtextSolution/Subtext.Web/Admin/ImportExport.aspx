...
<ANW:PAGE id="PageContainer" runat="server" TabSectionID="ImportExport">
	...
	<ANW:AdvancedPanel id="Action" runat="server" Collapsible="False" HeaderText="Options" HeaderCssClass="CollapsibleHeader"
		...
		<FIELDSET>
			...
			<!-- Uncomment once we build a BlogML Reader.
			<HR>
			<H4>Import from BlogML.</H4>
			<P>Allows you to import an existing blog by loading BlogML content.</P>
			<P><INPUT id="filImportBlogML" type="file" name="filImportBlogML" runat="server">
				<asp:LinkButton id="btnLoad" runat="server" Text="Load"></asp:LinkButton></P>
			-->
		</FIELDSET>
	</ANW:AdvancedPanel>
</ANW:PAGE>
