    ...
    public class SubtextMembershipProvider : System.Web.Security.MembershipProvider
    {
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            ...
            using (conn)
            {
                ...
                if (cmd.ExecuteNonQuery() == 1)
                {
                    MembershipUser retVal = new MembershipUser("SubtextMembershipProvider", username,
                        -9, "email@address.com", string.Empty, string.Empty, true, false, DateTime.Now,
                        DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MaxValue);
                    return retVal;
                }
                else
                {
